...
export default function Browser() {
  return (
    <div className="flex flex-1 flex-col items-center justify-center">
      <div className="relative mx-auto grid w-full max-w-screen-md overflow-hidden rounded-2xl bg-zinc-900/40 p-2">
        <div className="relative rounded-xl bg-zinc-950 shadow">
          <div className="flex flex-col rounded-xl">
            <div className="flex items-center border-b border-zinc-900 px-4 py-2">
              ...
              <div className="hidden flex-1 items-center justify-center gap-1 rounded-md bg-zinc-900 py-0.5 xl:flex">
                <svg
              ...
              <div className="hidden flex-1 justify-end gap-4 xl:flex">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  className="text-ln-zinc-300 size-[18px]"
                >
                  <path
                    stroke="currentColor"
                    strokeLinecap="round"
            ...
            <div className="zincscale min-h-96 py-12"></div>
          </div>
        </div>
      </div>
    </div>
