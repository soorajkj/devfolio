...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden">
      <Container>
        <div className="relative py-16 pb-0">
          <div className="grid w-full grid-cols-1 gap-4 divide-y divide-dashed divide-zinc-900">
            ...
            <div className="grid grid-cols-1">
              <div className="flex flex-col items-center justify-between p-6 lg:flex-row">
                <div className="flex items-center">
                  <p className="text-sm">
                    © {new Date().getFullYear()} Soorajkj.portfolio. All rights
                    reserved.
                  </p>
                </div>
              </div>
