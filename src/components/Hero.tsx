      ...
      <Container>
        <div className="bg-zinc-950 p-6">
          <div className="flex flex-col items-center gap-6 py-32">
            <h2 className="font-family-bebas-neue mx-auto w-full max-w-4xl text-center text-4xl leading-none text-white md:text-6xl">
              Sooraj Janardhanan — Frontend Developer building delightful web
              experiences.
            </h2>
